...
export class ConstructionProjectComponent extends EntityComponent<ConstructionProjectService> {
    ...
    initFields(): Field[] {
        return [
            ...
            FieldUtils.buildPopupForOrganization({ code: 'regulatoryUnit', name: '监管单位', list: { align: 'center' } }),
            ...
            FieldUtils.buildPopupForStaff({ code: 'suManager', name: '总监理工程师', list: { width: 110, align: 'center', render: (field: Field, row: any) => row.suManager?.person?.name } }),
