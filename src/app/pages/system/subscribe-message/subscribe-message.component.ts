...
import { SubscribeMessageService } from 'src/app/services/system/subscribe-message.service';
...
@Component({
    ...
    styleUrls: ['./subscribe-message.component.scss']
})
export class SubscribeMessageComponent extends EntityComponent<SubscribeMessageService> {
    ...
    constructor(
        public override entity: SubscribeMessageService,
